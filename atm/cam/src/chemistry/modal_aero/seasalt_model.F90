...
! FOR DEBUGGING
    debug: if (debug_mam_mom) then
       ...
       call addfld('omf_bub_section_mpoly', ' ', 1, 'A', 'omf poly', phys_decomp )
       call add_default ('omf_bub_section_mpoly', 1, ' ')

       call addfld('omf_bub_section_mprot', ' ', 1, 'A', 'omf prot', phys_decomp )
       call add_default ('omf_bub_section_mprot', 1, ' ')

       call addfld('omf_bub_section_mlip', ' ', 1, 'A', 'omf lip', phys_decomp )
